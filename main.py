...
data_train_input = np.array(Data_train[param][0:train_size])
data_train_target = np.array(Data_train[['isSignal']][:train_size])


my_layer1 = lib2.Linear(6,4)
my_layer2 = lib2.Tanh()
my_layer3 = lib2.Linear(4,2)
my_layer4 = lib2.Tanh()
my_layer5 = lib2.Linear(2,1)
my_layer6 = lib2.Sigmoid()
my_NN = lib2.NeuralNet([my_layer1, my_layer2, my_layer3, my_layer4, my_layer5, my_layer6])

lib2.train(my_NN, data_train_input, data_train_target , size_training=train_size, num_epochs = 5000, lr=0.01, batch_size=100)
